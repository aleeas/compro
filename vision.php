			...
			<div class="content-others">
				...
				<div class="content-inner">
					<div class="content-images">
						...
						<img class="" src="themes/default/assets/images/Sub Menu TENTANG KAMI - VISI MISI.jpg" style="object-fit:cover">
					</div>
					<div class="content-descriptions">
						...
						<p> 
						Menjadi mitra usaha konsultan asuransi yang berkualitas
						baik dan menguntungkan bagi nasabah dan perusahaan asuransi.</p>

						<h4><strong>Misi</strong><br></h4>

						<p> 
						- Memberikan solusi dan layanan asuransi yang terbaik bagi
						nasabah dengan pelayanan yang menyeluruh sesuai dengan
						kebutuhan dan kondisi nasabah. <br><br>
						- Melakukan terobosan dan inovasi yang diwujudkan dalam
						pengembangan produk serta pelayanan jasa pialang dan
						konsultan asuransi. </p>
						</div>
					</div>
