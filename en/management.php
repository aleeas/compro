			...
			<div class="content-others">
				...
				<div class="content-inner">
					...
					<div class="top-content-right"></div>
						...
						<div class="ui list">
						  <h4>Board of Commissioner</h4>
						  <div class="item">
						    <span class="title-heading">President Comm</span>
						    <div class="content">
						      <p>Ronald Pardede, SE, AAAIJ</p>
						    </div>
						  </div>
						  <div class="item">
						    <span class="title-heading"> Commissioner</span>
						    <div class="content">
						  ...
						  <div class="item">
						    <span class="title-heading">President Director  </span>
						    <div class="content">
						      <p>Robert B. Manurung, SH, MH</p>
						    </div>
						  </div>
						  <div class="item">
						    <span class="title-heading">Director</span>
						    <div class="content">
