			...
			<div class="content-others">
				...
				<div class="content-inner">
					...
					<div class="content-descriptions">
						...
						<h4><i class="checkmark icon"></i> KONSULTAN ASURANSI &amp; KLAIM ASURANSI </h4>
						<div class="ui ordered list">
						  <span class="item">Perancangan program asuransi</span>
						  <span class="item">Konsultasi Asuransi.</span>
						  <span class="item">Penempatan Asuransi/Reasuransi Terbaik.</span>
						  <span class="item">Pelaporan &amp; Penanganan Klaim.</span>
						  <span class="item">Claim Management Service.</span>
						</div>

						<h4><i class="checkmark icon"></i> MANAJEMEN RISIKO</h4>
